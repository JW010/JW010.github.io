...
(function ($) {
	...
	// =============
	var $ttSpSliderThumbsSwiper = new Swiper(
		$(".single-product-slider-thumbs").find(".swiper")[0],
		{
			slidesPerView: 4,
			slidesPerGroup: 1,
			spaceBetween: 15,
	...
	// =============
	var $ttSpSliderSwiper = new Swiper(
		$(".single-product-slider").find(".swiper")[0],
		{
			slidesPerView: 1,
			// effect: "fade",
			spaceBetween: 15,
	...
	if ($(".tt-product-carousel").length) {
		$(".tt-product-carousel").each(function () {
			...
			var $dataLoop = $ttProductCarousel.data("loop")
				? { loopedSlides: 100 }
				: $ttProductCarousel.data("loop");
			var $dataAutoplay = $ttProductCarousel.data("autoplay")
				? { delay: $ttProductCarousel.data("autoplay") }
				: $ttProductCarousel.data("autoplay");
			...
			// Init Swiper
			// =============
			var $ttProductCarouselSwiper = new Swiper(
				$ttProductCarousel.find(".swiper")[0],
				{
					slidesPerView: 1,
					slidesPerGroup: 1,
					preloadImages: false, // Needed for lazy loading
	...
	$(".spr-add-to-wishlist-btn, .spr-add-to-compare-btn").on(
		"click",
		function () {
